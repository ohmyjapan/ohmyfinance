...
export function parseCardImport(bytes:Uint8Array,account:any,metadata:any):{parserVersion:string;encoding:string;sha256:string;rows:CardRow[];sourceStatus?:string;sourceFormat?:string;sourceCapturedAt?:string;period:{kind:'statement'|'recent'|'custom'|'pending';start:string;end:string;key:string;statementMonth?:string;fiscalPeriod?:{start:string;end:string}};reconciliation?:{statementTotal:number;purchaseTotal:number;separateRefundTotal:number;verified:boolean}};
