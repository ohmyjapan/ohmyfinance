...
const historyLabel = (action: string) => ({ service_review: 'サービス利用料の候補を確認', chat_review: '会話で購入内容を確認', teaching_status: '学習ルールの適用を変更', slack_review: 'Slackで購入内容を確認', saved: '下書きを保存', approved: '内容を確認', document_added: '書類を添付', document_removed: '書類を削除' }[action] || action)
