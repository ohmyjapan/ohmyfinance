...
import {reportSchema,validateReport,validateSources,purposeContract,numericValueContract,referenceValueContract,validationFeedback} from '../shared/finance-research.mjs';
