<template>
  <section class="card mb-6 p-4 sm:p-6" aria-label="購入内容の確認">
    <div class="flex flex-wrap items-start justify-between gap-3">
      <div><h2 class="text-sm font-semibold text-gray-900 dark:text-gray-100">購入内容を一緒に確認</h2><p class="mt-1 text-xs leading-relaxed text-gray-500 dark:text-gray-400">過去の記録から用途を考え、Slackで確認した答えを下書きに反映します。</p></div>
    ...
    <template v-if="data">
      ...
      <div v-else class="mt-4 space-y-3 border-t border-gray-200 pt-4 dark:border-white/10">
