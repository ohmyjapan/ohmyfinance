...
const agent=new Schema({ownerId:{type:oid,required:true},accountIds:[oid],tokenHash:{type:String,required:true,unique:true},enabled:{type:Boolean,default:true},lastSeenAt:Date,revokedAt:Date},{timestamps:true})
