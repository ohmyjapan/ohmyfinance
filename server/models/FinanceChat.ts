...
const agent=new Schema({ownerId:{type:oid,required:true},accountIds:[oid],tokenHash:{type:String,required:true,unique:true},enabled:{type:Boolean,default:true},workspaceEnabled:{type:Boolean,default:false},documentEnabled:{type:Boolean,default:false},researchEnabled:{type:Boolean,default:false},researchStatus:mixed,lastSeenAt:Date,revokedAt:Date},{timestamps:true})
