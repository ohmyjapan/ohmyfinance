...
import { learningOverview, learningPatterns, learningDetail, learningRows, learningRow, saveLearningDecision } from '../../services/financeLearningService'
export default defineEventHandler(async event => {
  ...
  try {
    ...
    if (event.method==='PUT' && parts.length===2 && parts[0]==='patterns') {
      ...
      return await saveLearningDecision(ownerId,parts[1],body)
    }
